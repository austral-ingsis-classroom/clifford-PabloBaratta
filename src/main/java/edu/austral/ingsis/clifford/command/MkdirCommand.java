...
//could add logic to one touch/mkdir command. but the design of directory could include links to their parent
public class MkdirCommand implements Command{
    ...
    public String execute() {
        ...
        Directory dir = new Directory(pwd.getPath() + "/" + pwd.getName(), dirName);
        pwd.addNode(dir);
